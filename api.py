...
# Cấp quyền truy cập cho thư mục static chứa ảnh (Có thể xóa nếu chỉ dùng link online)
...
def serve_frontend():
    ...
    <head>
        ...
        <style>
            ...
            .btn-finish { 
                display: none; /* Ẩn mặc định, chỉ hiện khi đã gen bài tập */
                width: 100%; 
    ...
    <body>
        ...
        <script>
            ...
            // ==========================================
            // TÍNH NĂNG 3: HOÀN THÀNH LẺ VÀ POPUP
            // ==========================================
            ...
            async function generateWorkout(mode) {
                ...
                try {
                    ...
                    renderWorkoutList(); 
                    btnFinish.style.display = 'block'; // Hiện lại nút tổng sau khi gen bài
            ...
            async function completeWorkout() {
                ...
                // Nhá ảnh động lực ăn mừng
                showMotivationPopup();

                // Xóa danh sách bài tập, ẩn nút hoàn thành tổng đi và làm sạch biến tạm
                document.getElementById('workout-list').innerHTML = '';
                document.getElementById('btnFinish').style.display = 'none';
                currentWorkoutData = []; 
            }

            // Lệnh quan trọng nhất để khởi động biểu đồ
...
def api_complete_workout(log: WorkoutLog):
    # Call HistoryManager (Hàm này hiện tại không còn dùng tới ở Frontend nhưng vẫn giữ lại làm backup)
