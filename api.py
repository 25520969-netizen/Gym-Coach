from typing import List # Em import thêm thư viện này để fix lỗi List[dict]
...
def serve_frontend():
    ...
    <body>
        ...
        <script>
            ...
            // Danh sách các ảnh khích lệ đã lưu trong thư mục static
            // Đảm bảo tên file và đuôi file khớp 100% với file anh để trong thư mục static nhé
