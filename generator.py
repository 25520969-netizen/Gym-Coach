...
class WorkoutGenerator:
    ...
    def _get_safe_targets(self, day_type):
        ...
        for target in candidate_targets:
            ...
            if "last_trained_timestamp" in hist and hist["last_trained_timestamp"]:
                last_trained = hist["last_trained_timestamp"]
    ...
    # ---------------------------------------------------------
    def generate_standard_workout(self, day_type, max_time, username: str):
        user_history = self.history_manager._load_and_aggregate_history(username)
    ...
    # ---------------------------------------------------------
    def generate_smart_workout(self, day_type, max_time, username: str):
        user_history = self.history_manager._load_and_aggregate_history(username)
